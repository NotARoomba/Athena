...
void HAL_FDCAN_MspDeInit(FDCAN_HandleTypeDef* hfdcan)
{
  if(hfdcan->Instance==FDCAN2)
  {
    ...
    PB13     ------> FDCAN2_TX
    */
    HAL_GPIO_DeInit(GPIOB, TPU_CAN_RX_Pin|TPU_CAN_TX_Pin);
...
void HAL_QSPI_MspDeInit(QSPI_HandleTypeDef* hqspi)
{
  if(hqspi->Instance==QUADSPI)
  {
    ...
    */
    ...
    HAL_GPIO_DeInit(FLASH_IO3_GPIO_Port, FLASH_IO3_Pin);

    HAL_GPIO_DeInit(GPIOB, FLASH_SCK_Pin|FLASH_CS_Pin);

    HAL_GPIO_DeInit(GPIOD, FLASH_IO0_Pin|FLASH_IO1_Pin);
...
void HAL_SPI_MspDeInit(SPI_HandleTypeDef* hspi)
{
  ...
  else if(hspi->Instance==SPI3)
  {
    ...
    PB4 (NJTRST)     ------> SPI3_MISO
    */
    HAL_GPIO_DeInit(GPS_MOSI_GPIO_Port, GPS_MOSI_Pin);

    HAL_GPIO_DeInit(GPIOB, GPS_SCK_Pin|GPS_MISO_Pin);
  ...
  else if(hspi->Instance==SPI4)
  {
    ...
    PE12     ------> SPI4_SCK
    */
    HAL_GPIO_DeInit(GPIOE, MCU_MISO_Pin|MCU_MOSI_Pin|MCU_SCK_Pin);
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* huart)
{
  ...
  else if(huart->Instance==USART1)
  {
    ...
    PA10     ------> USART1_RX
    */
    HAL_GPIO_DeInit(GPIOA, TPU_TX_EX_Pin|TPU_RX_EX_Pin);
