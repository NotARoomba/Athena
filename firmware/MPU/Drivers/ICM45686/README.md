...
Files:
* `inv_imu_transport.h`: Definition of the abstraction layer used to communicate with the IMU.
* `inv_imu_transport.c`: Implementation of the abstraction layer used to communicate with the IMU.
* `inv_imu.h`: Describes IMU specificities and capabilities.
* `inv_imu_regmap_le.h`: Exposes register map using bit-field representation in Little Endian.
* `inv_imu_regmap_be.h`: Exposes register map using bit-field representation in Big Endian.
* `inv_imu_defs.h`: Defines possible values for most used registers.

By default, the driver will include the Little Endian variant of the register map (`inv_imu_regmap_le.h`) which suits the majority of microcontroller. In case your microcontroller is Big Endian, you might have to change it in the `inv_imu_defs.h`:
```C
...
Files:
* `inv_imu_driver.h`: Definition of the basic driver API.
* `inv_imu_driver.c`: Implementation of the basic driver API.
* `inv_imu_version.h`: Contains the driver's version as a string. 
...
Files:
* `inv_imu_driver_advanced.h`: Definition of the advanced driver API.
* `inv_imu_driver_advanced.c`: Implementation of the advanced driver API.
...
Files:
* `inv_imu_selftest.h`: Definition of the self-test module API.
* `inv_imu_selftest.c`: Implementation of the self-test module API.
...
Files:
* `inv_imu_edmp.h`: Definition of the EDMP module API.
* `inv_imu_edmp.c`: Implementation of the EDMP module API.
* `inv_imu_edmp_memmap.h`: Exposes memory map of the EDMP (addresses and size of the required variables).
* `inv_imu_edmp_defs.h`: Defines useful values for EDMP.
...
Files:
* `inv_imu_driver_aux1.h`: Definition of the AUX1 module API.
* `inv_imu_driver_aux1.c`: Implementation of the AUX1 module API.
* `inv_imu_driver_aux2.h`: Definition of the AUX2 module API.
* `inv_imu_driver_aux2.c`: Implementation of the AUX2 module API.
