...
void HAL_FDCAN_MspDeInit(FDCAN_HandleTypeDef* hfdcan)
{
  if(hfdcan->Instance==FDCAN1)
  {
    ...
    PD1     ------> FDCAN1_TX
    */
    HAL_GPIO_DeInit(GPIOD, MPU_CAN_RX_Pin|MPU_CAN_TX_Pin);
...
void HAL_SPI_MspDeInit(SPI_HandleTypeDef* hspi)
{
  if(hspi->Instance==SPI1)
  {
    ...
    PD7     ------> SPI1_MOSI
    */
    HAL_GPIO_DeInit(GPIOA, IMU_SCK_Pin|IMU_MISO_Pin);
  ...
  else if(hspi->Instance==SPI4)
  {
    ...
    PE6     ------> SPI4_MOSI
    */
    HAL_GPIO_DeInit(GPIOE, BAR_SCK_Pin|BAR_MISO_Pin|BAR_MOSI_Pin);
  ...
  else if(hspi->Instance==SPI6)
  {
    ...
    PB4 (NJTRST)     ------> SPI6_MISO
    */
    HAL_GPIO_DeInit(MCU_MOSI_GPIO_Port, MCU_MOSI_Pin);

    HAL_GPIO_DeInit(GPIOB, MCU_SCK_Pin|MCU_MISO_Pin);
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* huart)
{
  ...
  else if(huart->Instance==UART8)
  {
    ...
    PE1     ------> UART8_TX
    */
    HAL_GPIO_DeInit(GPIOE, SPU_RX_Pin|SPU_TX_Pin);
  ...
  else if(huart->Instance==USART1)
  {
    ...
    PA10     ------> USART1_RX
    */
    HAL_GPIO_DeInit(GPIOA, MPU_TX_EX_Pin|MPU_RX_EX_Pin);
