...
void HAL_FDCAN_MspDeInit(FDCAN_HandleTypeDef* hfdcan)
{
  if(hfdcan->Instance==FDCAN2)
  {
    ...
    PB6     ------> FDCAN2_TX
    */
    HAL_GPIO_DeInit(GPIOB, SPU_CAN_RX_Pin|SPU_CAN_TX_Pin);
...
void HAL_I2C_MspDeInit(I2C_HandleTypeDef* hi2c)
{
  if(hi2c->Instance==I2C1)
  {
    ...
    PA14     ------> I2C1_SDA
    */
    HAL_GPIO_DeInit(SPU_PD_SCL_GPIO_Port, SPU_PD_SCL_Pin);

    HAL_GPIO_DeInit(SPU_PD_SDA_GPIO_Port, SPU_PD_SDA_Pin);
...
void HAL_SPI_MspDeInit(SPI_HandleTypeDef* hspi)
{
  if(hspi->Instance==SPI1)
  {
    ...
    PA7     ------> SPI1_MOSI
    */
    HAL_GPIO_DeInit(GPIOA, MCU_SCK_Pin|MCU_MISO_Pin|MCU_MOSI_Pin);
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* huart)
{
  if(huart->Instance==UART5)
  {
    ...
    PD2     ------> UART5_RX
    */
    HAL_GPIO_DeInit(SPU_RX_GPIO_Port, SPU_RX_Pin);
  ...
  else if(huart->Instance==USART1)
  {
    ...
    PC5     ------> USART1_RX
    */
    HAL_GPIO_DeInit(GPIOC, SPU_TX_EX_Pin|SPU_RX_EX_Pin);
